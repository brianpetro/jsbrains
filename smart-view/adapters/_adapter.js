export class SmartViewAdapter {
   ...
   * @param {object} scope - The current scope containing settings and actions.
   */
  pre_change(path, value, elm) { throw new Error("pre_change() not implemented"); }
  /**
   ...
   */
  post_change(path, value, elm) { throw new Error("post_change() not implemented"); }
  /**
   ...
   */
  revert_setting(path, elm, scope) { throw new Error("revert_setting() not implemented"); }
