export type SettingsChangeType = "set" | "delete";
/**
...
export type SettingsChange = {
     ...
     * - Mutation type.
     */
    type: import("./smart-settings.js").SettingsChangeType;
    /**
    ...
    value?: any;
    /**
     * - Previous value before the mutation.
     */
    previous_value?: any;
};
/**
...
export type SettingsEventsBus = {
    /**
     * - Event bus emit function used by SmartSettings.
     */
...
export type SmartSettingsCreateOptions = {
    /**
     * - Debounced save delay in milliseconds.
     */
    save_delay_ms?: number;
    /**
     * - Optional events bus override.
     */
    events?: import("./smart-settings.js").SettingsEventsBus;
    /**
     * - Optional emit shortcut used when events bus is not supplied.
     */
    emit?: (arg0: string, arg1: any) => void;
    /**
